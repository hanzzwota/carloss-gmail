    ...
    <div className="space-y-4 pb-24 max-w-md mx-auto px-4 pt-3">
      ...
      {user.qualityScore <= 20 && user.qualityScore > 0 && (
        <div className="p-3.5 bg-rose-50 border border-rose-200 rounded-2xl text-rose-800 text-xs flex items-start gap-2.5 shadow-sm animate-pulse">
          ...
          <div>
            <div className="font-bold text-rose-900">Peringatan Kualitas Akun Rendah</div>
      ...
      {settings.isStorOpen ? (
        <div className="p-4 bg-emerald-500/10 border border-emerald-500/30 rounded-2xl text-emerald-950 flex items-center justify-between shadow-xs">
          ...
          <button
            ...
            className="px-3.5 py-2 rounded-xl bg-emerald-600 hover:bg-emerald-500 active:scale-95 text-white text-xs font-bold shadow-sm cursor-pointer transition-all shrink-0"
          >
            Setor Sekarang
          </button>
        </div>
      ) : (
        <div className="p-4 bg-rose-500/10 border border-rose-500/30 rounded-2xl text-rose-950 flex items-center justify-between shadow-xs">
          <div className="flex items-center gap-3">
            <span className="w-2.5 h-2.5 rounded-full bg-rose-500 shrink-0" />
            <div>
              <div className="font-black text-xs text-rose-800 flex items-center gap-1.5">
          ...
          <span className="px-2.5 py-1 rounded-lg bg-rose-200/80 text-rose-800 text-[10px] font-bold shrink-0">
            Tutup
          </span>
        </div>
      )}
